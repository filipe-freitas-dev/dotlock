...
pub fn generate_identity(passphrase: &str) -> DotLockResult<GeneratedIdentity> {
    let mut rng = OsRng;
...
mod tests {
    use super::{
        RECIPIENT_ALG, decrypt_private_key_pem, encode_public_key_b64, generate_identity,
        unwrap_dek_with_private_key, wrap_dek_for_public_key, wrap_dek_for_public_key_b64,
    };
